  ...
  return (
    <Nav $scrolled={scrolled}>
      ...
      <Links>
        ...
        <Link
          href={`https://wa.me/262692421519?text=${encodeURIComponent("Bonjour ! Je souhaite une montre personnalisée qui ne figure pas dans vos options. Pouvez-vous m'aider ?")}`}
