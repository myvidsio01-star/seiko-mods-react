...
const watches = [
  ...
  { name: 'Royal Oak',      price: '250 €', stars: 4, tag: 'Exclusif',    img: '/images/watch-royaloak.png',   filter: 'none' },
  ...
  { name: 'Day-Date',       price: '250 €', stars: 3, tag: 'Prestige',    img: '/images/watch-daydate.png',    filter: 'none' },
]
